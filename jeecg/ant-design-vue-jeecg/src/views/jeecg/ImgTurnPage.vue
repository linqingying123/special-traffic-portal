<template>
  <a-card style="min-width: 800px;overflow-x:auto " title="树形结构图片翻页查看">
    <a-row>
      <!-- 左侧文件树 -->
      <a-col :span="5">
        <a-tree
      ...
      <a-col :span="19">
        <a-row style="margin-top: 10px">
          <a-col :span="24" style="padding-left: 2%;margin-bottom: 10px">
            <a-button type="primary" @click="prev"><a-icon type="left" />上一页</a-button>
            <a-button style="margin-left: 8px" type="primary" @click="next">下一页<a-icon type="right" /></a-button>
