<template>
  <div :id="containerId" style="position: relative">
    ...
    <!--  ---------------------------- begin 图片左右换位置 ------------------------------------- -->
    <div :style="{top:top+'px',left:left+'px',display:moveDisplay}" class="movety-container" style="padding:0 8px;position: absolute;z-index: 91;height: 32px;width: 104px;text-align: center;">
      <div :id="containerId+'-mover'" :class="showMoverTask?'uploadty-mover-mask':'movety-opt'" style="margin-top: 12px">
        <a style="margin: 0 5px;" @click="moveLast"><a-icon style="color: #fff;font-size: 16px" type="arrow-left"/></a>
        <a style="margin: 0 5px;" @click="moveNext"><a-icon style="color: #fff;font-size: 16px" type="arrow-right"/></a>
      </div>
    </div>
    <!--  ---------------------------- end 图片左右换位置 ------------------------------------- -->
