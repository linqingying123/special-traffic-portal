  ...
  <a-card :bordered="false">
    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="12">
          <a-col :md="7" :sm="8">
            <a-form-item :labelCol="{span: 6}" :wrapperCol="{span: 14, offset: 1}" label="字典名称">
              <a-input v-model="queryParam.dictName" placeholder="请输入字典名称"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="7" :sm="8">
            <a-form-item :labelCol="{span: 6}" :wrapperCol="{span: 14, offset: 1}" label="字典编号">
              <a-input v-model="queryParam.dictCode" placeholder="请输入字典编号"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="7" :sm="8">
      ...
      <div class="table-operator" style="border-top: 5px">
        ...
        <a-button icon="download" type="primary" @click="handleExportXls('字典信息')">导出</a-button>
        ...
        <a-button icon="sync" type="primary" @click="refleshCache()">刷新缓存</a-button>

        <a-button icon="hdd" type="primary" @click="openDeleteList">回收站</a-button>
      </div>
