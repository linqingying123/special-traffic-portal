<template>
  <div class="page-header-index-wide">
    <a-card :bodyStyle="{ padding: '16px 0', height: '100%' }" :bordered="false" :style="{ height: '100%' }">
      <div :class="device" :style=" 'min-height:'+ mainInfoHeight " class="account-settings-info-main">
        ...
        <div class="account-settings-info-right">
          ...
          <security v-if="security" ref="security"></security>
          <base-setting v-if="baseSetting" ref="baseSetting"></base-setting>
          <custom v-if="custom" ref="custom"></custom>
          <notification v-if="notification" ref="notification"></notification>
          <binding v-if="binding" ref="binding"></binding>
        </div>
      </div>
    </a-card>
  </div>
