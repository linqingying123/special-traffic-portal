  ...
  <a-row :gutter="10">
    <a-col :md="12" :sm="24">
      <a-card :bordered="false">
        ...
        <!-- 按钮操作区域 -->
        <a-row class="table-operator" style="margin: 0 0 0 14px">
          <a-button type="primary" @click="handleAdd(1)">添加部门</a-button>
          <a-button type="primary" @click="handleAdd(2)">添加下级</a-button>
          <a-button icon="download" type="primary" @click="handleExportXls('部门信息')">导出</a-button>
          ...
          <j-third-app-button :selected-row-keys="selectedRowKeys" biz-type="depart" syncToApp @sync-finally="onSyncFinally"/>
          <a-button title="删除多条数据" type="default" @click="batchDel">批量删除</a-button>
        </a-row>
        <div style="background: #fff;padding-left:16px;height: 100%; margin-top: 5px">
          ...
          <a-input-search placeholder="请输入部门名称" style="width:100%;margin-top: 10px" @search="onSearch"/>
          <!-- 树-->
          <div>
    ...
    <a-col :md="12" :sm="24">
      <a-tabs defaultActiveKey="1">
        <a-tab-pane key="1" tab="基本信息" >
          <a-card v-if="selectedKeys.length>0" :bordered="false">
            <a-form-model ref="form" :model="model" :rules="validatorRules">
              ...
              <a-form-model-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="上级部门" prop="parentId">
                <a-tree-select v-model="model.parentId" :disabled="disable"  :dropdownStyle="{maxHeight:'200px',overflow:'auto'}" :treeData="treeData" placeholder="无"  style="width:100%">
                </a-tree-select>
              </a-form-model-item>
              <a-form-model-item  :labelCol="labelCol" :wrapperCol="wrapperCol" label="机构编码" prop="orgCode">
                <a-input v-model="model.orgCode" disabled placeholder="请输入机构编码"/>
              </a-form-model-item>
            ...
            <div class="anty-form-btn">
              <a-button htmlType="button" icon="sync" type="default" @click="emptyCurrForm">重置</a-button>
              <a-button htmlType="button" icon="form" type="primary" @click="submitCurrForm">保存</a-button>
            </div>
          </a-card>
          <a-card v-else >
            <a-empty>
        ...
        <a-tab-pane key="2" forceRender tab="部门权限">
