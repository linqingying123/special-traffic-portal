<template>
  <a-card :bordered="false">
    <a-form-model ref="form" :model="model" :rules="rules" @submit="handleSubmit">
      <a-row>
      <a-col :md="24" :sm="24">
      <a-form-model-item :labelCol="{ span: 7 }" :wrapperCol="{ span: 15 }" label="Note" prop="note">
      ...
      <a-row>
      <a-col :md="24" :sm="24">
      <a-form-model-item :labelCol="{ span: 7 }" :wrapperCol="{ span: 15 }" label="Gender" prop="gender">
      ...
      <a-row>
      <a-col :md="24" :sm="24">
      <a-form-model-item :labelCol="{ span: 7 }" :wrapperCol="{ span: 15 }" label="Gender" prop="cascader">
        <a-cascader :options="areaOptions" :showSearch="{filter}" placeholder="Please select" @change="onChange" />
      </a-form-model-item>
      </a-col>
      </a-row>
