  ...
  <a-card :bordered="false">
    <template v-if="this.departId">
          ...
          <a-form-item label='所拥有的权限'>
            <a-tree
              ...
              <span slot="hasDatarule" slot-scope="{slotTitle,ruleFlag}">
                {{ slotTitle }}
                <a-icon v-if="ruleFlag" style="margin-left:5px;color: red;" type="align-left"></a-icon>
              </span>
            </a-tree>
          </a-form-item>
        </a-form>
      ...
      <div class="anty-form-btn">
        ...
        <a-button htmlType="button" icon="form" style="float: right" type="primary" @click="handleSubmit">保存</a-button>
      </div>
    </template>
