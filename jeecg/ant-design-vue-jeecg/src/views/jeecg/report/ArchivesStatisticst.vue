        ...
        <a-row>
          ...
          <a-col :span="14">
            <a-form v-if="barType === 'month' && false" layout="inline" style="margin-top: -4px">
              ...
              <a-button icon="search" style="margin-top: 2px" type="primary" @click="queryDatebar">查询</a-button>
              <a-button icon="reload" style="margin-top: 2px;margin-left: 8px" type="primary" @click="searchReset">重置</a-button>
            </a-form>
          </a-col>
          <bar :dataSource="countSource" :height="400" class="statistic" title="档案统计"/>
        </a-row>
      </a-tab-pane>

      <a-tab-pane key="2" tab="饼状图">
        <a-row :gutter="24">
          <a-col :span="10">
          ...
          <a-col :span="14">
            <a-form v-if="pieType === 'month' && false" layout="inline" style="margin-top: -4px">
              <a-row :gutter="24">
                ...
                <a-button icon="search" style="margin-top: 2px" type="primary" @click="queryDatepie">查询</a-button>
                <a-button icon="reload" style="margin-top: 2px;margin-left: 8px" type="primary" @click="searchReset">重置</a-button>
              </a-row>
            </a-form>
          </a-col>
          <pie :dataSource="countSource" :height="450" class="statistic" title="档案统计"/>
        </a-row>
      </a-tab-pane>
    </a-tabs>
  </a-card>
