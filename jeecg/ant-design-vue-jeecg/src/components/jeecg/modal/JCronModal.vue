      ...
      <a-tabs type="card">
        <a-tab-pane key="1" type="card">
          ...
          <a-radio-group v-model="result.second.cronEvery">
            ...
            <a-row>
              <a-radio value="2">每隔
                <a-input-number v-model="result.second.incrementIncrement" :max="59" :min="1" size="small"></a-input-number>
                秒执行 从
            ...
            <a-row>
              <a-radio value="4">周期从
                <a-input-number v-model="result.second.rangeStart" :max="59" :min="1" size="small"></a-input-number>
                到
        ...
        <a-tab-pane key="2">
          ...
          <div class="tabBody">
            <a-radio-group v-model="result.minute.cronEvery">
              ...
              <a-row>
                <a-radio value="2">每隔
                  <a-input-number v-model="result.minute.incrementIncrement" :max="60" :min="1" size="small"></a-input-number>
                  分执行 从
                  <a-input-number v-model="result.minute.incrementStart" :max="59" :min="0" size="small"></a-input-number>
                  分开始
                </a-radio>
              </a-row>
              <a-row>
        ...
        <a-tab-pane key="3">
          ...
          <div class="tabBody">
            <a-radio-group v-model="result.hour.cronEvery">
              ...
              <a-row>
                <a-radio value="2">每隔
                  <a-input-number v-model="result.hour.incrementIncrement" :max="23" :min="0" size="small"></a-input-number>
                  小时执行 从
        ...
        <a-tab-pane key="4">
          ...
          <div class="tabBody">
            <a-radio-group v-model="result.day.cronEvery">
              ...
              <a-row>
                <a-radio value="2">每隔
                  <a-input-number v-model="result.week.incrementIncrement" :max="7" :min="1" size="small"></a-input-number>
                  周执行 从
              ...
              <a-row>
                <a-radio value="3">每隔
                  <a-input-number v-model="result.day.incrementIncrement" :max="31" :min="1" size="small"></a-input-number>
                  天执行 从
              ...
              <a-row>
                <a-radio value="9">
                  在本月底前
                  <a-input-number v-model="result.day.cronDaysBeforeEomMinus" :max="31" :min="1" size="small"></a-input-number>
                  天
                </a-radio>
              </a-row>
              <a-row>
                <a-radio value="10">最近的工作日（周一至周五）至本月
                  <a-input-number v-model="result.day.cronDaysNearestWeekday" :max="31" :min="1" size="small"></a-input-number>
                  日
                </a-radio>
              </a-row>
              <a-row>
        ...
        <a-tab-pane key="5">
          ...
          <div class="tabBody">
            <a-radio-group v-model="result.month.cronEvery">
              ...
              <a-row>
                <a-radio value="2">每隔
                  <a-input-number v-model="result.month.incrementIncrement" :max="12" :min="0" size="small"></a-input-number>
                  月执行 从
                  <a-input-number v-model="result.month.incrementStart" :max="12" :min="0" size="small"></a-input-number>
                  月开始
                </a-radio>
              </a-row>
              <a-row>
                <a-radio class="long" value="3">具体月数(可多选)</a-radio>
                <a-select v-model="result.month.specificSpecific" filterable mode="multiple" size="small" style="width:354px;">
        ...
        <a-tab-pane key="6">
          ...
          <div class="tabBody">
            <a-radio-group v-model="result.year.cronEvery">
              ...
              <a-row>
                <a-radio value="2">每隔
                  <a-input-number v-model="result.year.incrementIncrement" :max="99" :min="1" size="small"></a-input-number>
                  年执行 从
                  <a-input-number v-model="result.year.incrementStart" :max="2119" :min="2019" size="small"></a-input-number>
                  年开始
                </a-radio>
              </a-row>
              <a-row>
                <a-radio class="long" value="3">具体年份(可多选)</a-radio>
                <a-select v-model="result.year.specificSpecific" filterable mode="multiple" size="small" style="width:354px;">
                  <a-select-option v-for="(val,index) in Array(100)" :key="index" :value="2019+index">{{ 2019+index }}</a-select-option>
                </a-select>
              </a-row>
              <a-row>
                <a-radio value="4">从
                  <a-input-number v-model="result.year.rangeStart" :max="2119" :min="2019" size="small"></a-input-number>
                  到
