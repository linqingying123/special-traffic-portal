<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          ...
          <a-col :span="6">
            <a-form-item label="标题">
              <a-input v-model="queryParam.titile" placeholder="请输入标题"></a-input>
            </a-form-item>
          </a-col>
          <!--<a-col :span="6">
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" type="primary" @click="handleExportXls('系统通告')">导出</a-button>
...
<!--      </a-upload>-->
    ...
    <!-- 查看详情 -->
    <j-modal :footer="null" :top="50" :visible.sync="detailModal.visible" :width="600" class="detail-modal" switchFullscreen title="查看详情">
      <iframe v-if="detailModal.url" :src="detailModal.url" class="detail-iframe"/>
    </j-modal>
