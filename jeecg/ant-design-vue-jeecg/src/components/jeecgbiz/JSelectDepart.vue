<template>
  <div class="components-input-demo-presuffix">
    <!---->
    <a-input v-model="textVals" :disabled="disabled" placeholder="请点击选择部门" readOnly @click="openModal">
      <a-icon slot="prefix" title="部门选择控件" type="cluster"/>
      <a-icon v-if="storeVals" slot="suffix" title="清空" type="close-circle" @click="handleEmpty"/>
    </a-input>
