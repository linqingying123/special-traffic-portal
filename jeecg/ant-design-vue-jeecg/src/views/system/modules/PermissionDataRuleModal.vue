    ...
    <a-spin :spinning="confirmLoading">
      <a-form-model ref="form" :model="model" :rules="validatorRules">
        ...
        <a-form-model-item
          ...
          label="规则字段"
          prop="ruleColumn">
          <a-input v-model.trim="model.ruleColumn" placeholder="请输入规则字段"/>
        </a-form-model-item>
        <a-form-model-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="条件规则"
          prop="ruleConditions">
          <j-dict-select-tag v-model="model.ruleConditions" dictCode="rule_conditions" placeholder="请输入条件规则" @input="handleChangeRuleCondition"/>
        </a-form-model-item>
        <a-form-model-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="规则值"
          prop="ruleValue">
          <a-input v-model="model.ruleValue" placeholder="请输入规则值"/>
        </a-form-model-item>
