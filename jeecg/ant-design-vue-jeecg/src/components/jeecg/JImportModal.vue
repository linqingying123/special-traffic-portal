<template>
  <a-modal
    ...
    <div v-if="online" style="margin: 0px 0px 5px 1px">
      ...
      <span style="display: inline-block;height: 32px;margin-left: 6px">
         <a-switch :checked="validateStatus==1" checked-children="是" size="small" un-checked-children="否" @change="handleChangeValidateStatus"/>
      </span>
    </div>
