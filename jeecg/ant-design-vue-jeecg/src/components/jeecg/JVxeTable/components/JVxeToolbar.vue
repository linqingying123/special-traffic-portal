<template>
  <div :class="boxClass">
    <!-- 工具按钮 -->
    <div :size="btnSize" class="j-vxe-tool-button div">
      <slot v-if="showPrefix" :size="btnSize" name="toolbarPrefix"/>

      <a-button v-if="showAdd" :disabled="disabled" icon="plus" type="primary" @click="trigger('add')">新增</a-button>
      <a-button v-if="showSave" :disabled="disabled" icon="save" @click="trigger('save')">保存</a-button>
      <template v-if="selectedRowIds.length > 0">
        ...
        >
          <a-button :disabled="disabled" icon="minus">删除</a-button>
        </a-popconfirm>
      ...
      <slot v-if="showSuffix" :size="btnSize" name="toolbarSuffix"/>
