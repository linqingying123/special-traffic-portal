<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          ...
          <a-col :lg="7" :md="8" :sm="24" :xl="6">
            <a-form-item label="用户名">
              <j-input v-model="queryParam.name" placeholder="请输入名称模糊查询"></j-input>
            </a-form-item>
          </a-col>
          <a-col :lg="7" :md="8" :sm="24" :xl="6">
            <a-form-item label="年龄">
             <!-- <a-input placeholder="请输入名称查询" v-model="queryParam.age"></a-input>-->
              <a-input v-model="queryParam.age_begin" placeholder="最小年龄" style="width:calc(50% - 15px);" type="ge"></a-input>
              <span class="group-query-strig">~</span>
              <a-input v-model="queryParam.age_end" placeholder="最大年龄" style="width:calc(50% - 15px);" type="le"></a-input>
            </a-form-item>
          </a-col>
          <template v-if="toggleSearchStatus">
            ...
            <a-col :lg="7" :md="8" :sm="24" :xl="6">
              <a-form-item label="性别">
                <j-dict-select-tag v-model="queryParam.sex" dictCode="sex" placeholder="请选择性别"/>
              </a-form-item>
            </a-col>
            <a-col :lg="7" :md="8" :sm="24" :xl="6">
              <a-form-item label="选择用户">
                <j-dict-select-tag v-model="queryParam.id" dictCode="demo,name,id" placeholder="请选择用户"/>
              </a-form-item>
            </a-col>
          </template>
    ...
    <div class="table-operator">
      ...
      <a-button icon="plus" type="primary" @click="jump">创建单据</a-button>
      <a-button icon="plus" type="primary" @click="onetomany">一对多</a-button>
      <a-button icon="download" type="primary" @click="handleExportXls('单表示例')">导出</a-button>
      ...
      <!-- 高级查询区域 -->
      <j-super-query ref="superQueryModal" :fieldList="fieldList" @handleSuperQuery="handleSuperQuery"></j-super-query>
                ...
                <a-row style="width: 400px">
                  <template v-for="(item,index) in defColumns">
                    <template v-if="item.key!='rowIndex'&& item.dataIndex!='action'">
                        <a-col :span="12"><a-checkbox :value="item.dataIndex"><j-ellipsis :length="10" :value="item.title"></j-ellipsis></a-checkbox></a-col>
                    </template>
                  </template>
                </a-row>
              </a-checkbox-group>
