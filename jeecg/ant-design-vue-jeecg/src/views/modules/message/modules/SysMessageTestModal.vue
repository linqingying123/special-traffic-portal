    ...
    <a-spin :spinning="confirmLoading">
      <a-form>
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="模板内容">
          <a-textarea v-model="templateContent" :autosize="{ minRows: 5, maxRows: 8 }" disabled/>
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="测试数据">
          <a-textarea v-model="testData" :autosize="{ minRows: 5, maxRows: 8 }" placeholder="请输入json格式测试数据"/>
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
