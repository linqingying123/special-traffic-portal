<template>
  <div v-if="avalid" class="components-input-demo-presuffix">
    <!---->
    <a-input v-model="showText" :disabled="disabled" :placeholder="placeholder" readOnly @click="openModal">
      <a-icon slot="prefix" :title="title" type="cluster"/>
      <a-icon v-if="showText" slot="suffix" title="清空" type="close-circle" @click="handleEmpty"/>
    </a-input>
