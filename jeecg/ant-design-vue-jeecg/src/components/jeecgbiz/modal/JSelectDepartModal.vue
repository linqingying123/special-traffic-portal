<template>
  <j-modal
    ...
    <a-spin :spinning="false" tip="Loading...">
      <a-input-search v-model="searchValue" placeholder="请输入部门名称按回车进行搜索" style="margin-bottom: 1px" />
    ...
    <!--底部父子关联操作和确认取消按钮-->
    <template v-if="treeOpera && multi" slot="footer">
      <div class="drawer-bootom-button">
        ...
        <a-button style="margin-right: 0.8rem" type="primary" @click="handleCancel">关闭</a-button>
