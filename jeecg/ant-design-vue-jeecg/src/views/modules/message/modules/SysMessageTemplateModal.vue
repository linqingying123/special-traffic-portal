        ...
        <a-row :gutter="{ xs: 8, sm: 16, md: 24, lg: 32 }">
          ...
          <a-col :span="12">
            <a-form-item
              ...
              :wrapperCol="wrapperCol"
              label="模板类型">
              <j-dict-select-tag  v-decorator="['templateType', validatorRules.templateType ]" :triggerChange="true" dictCode="msgType" placeholder="请选择模板类型" @change="handleChangeTemplateType">
              </j-dict-select-tag>
            </a-form-item>
          </a-col>
        </a-row>
        ...
        <a-row :gutter="24" class="form-row">
          <a-col :span="24" pull="4">
            <a-form-item
              ...
              <a-textarea v-decorator="['templateContent', validatorRules.templateContent ]" :autosize="{ minRows: 8, maxRows: 8 }" placeholder="请输入模板内容"/>
            </a-form-item>
          </a-col>
        </a-row>
        <a-row :gutter="24" class="form-row">
