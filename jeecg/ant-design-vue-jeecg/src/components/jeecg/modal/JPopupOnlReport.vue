  ...
  <j-modal
    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline" @keyup.enter.native="searchByquery">
        <a-row v-if="showSearchFlag" :gutter="24">
          <template v-for="(item,index) in queryInfo">
            <template v-if=" item.hidden==='1' ">
              <a-col v-show="toggleSearchStatus" :key=" 'query'+index " :md="8" :sm="24">
                <online-query-form-item :dictOptions="dictOptions" :item="item" :queryParam="queryParam"></online-query-form-item>
              </a-col>
            </template>
            <template v-else>
              <a-col :key=" 'query'+index " :md="8" :sm="24">
                <online-query-form-item :dictOptions="dictOptions" :item="item" :queryParam="queryParam"></online-query-form-item>
              </a-col>
            </template>
          </template>
          ...
          <a-col :md="8" :sm="8">
            <span class="table-page-search-submitButtons" style="float: left;overflow: hidden;">
              <a-button icon="search" type="primary" @click="searchByquery">查询</a-button>
