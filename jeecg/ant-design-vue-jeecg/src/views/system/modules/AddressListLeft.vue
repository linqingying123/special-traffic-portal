<template>
  <a-card :bordered="false" :loading="cardLoading" style="height: 100%;">
    <a-spin :spinning="loading">
      <a-input-search enterButton placeholder="输入机构名称查询..." style="width:100%;margin-top: 10px" @search="handleSearch" />
