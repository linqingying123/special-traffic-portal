    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          label="用户名">
          <a-input v-decorator="['userName', {}]" placeholder="请输入用户名" readOnly/>
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="代理人用户名">
          <j-select-user-by-dep v-decorator="['agentUserName', validatorRules.agentUserName]" :multi="false" :trigger-change="true" placeholder="请输入代理人用户名"></j-select-user-by-dep>
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
