    ...
    <a-col :md="8" :sm="24">
      <a-card :bordered="false">
        <div style="background: #fff;padding-left:16px;height: 100%; margin-top: 5px">
          ...
          <div v-else-if="userIdentity === '2' && departTree.length==0" style="margin-top: 24px;">
            <h3><span>您的部门下暂无有效部门信息</span></h3>
          </div>
          <div v-else style="margin-top: 24px;"><h3>普通员工暂无此权限</h3></div>
        </div>
      </a-card>
    </a-col>
    <a-col :md="16" :sm="24">
      <a-card :bordered="false">
        <a-tabs defaultActiveKey="2" @change="callback">
          <a-tab-pane key="1" forceRender tab="基本信息">
          ...
          <a-tab-pane key="3" forceRender tab="部门角色">
