    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          label="数据源编码">
          <a-input v-decorator="['code', validatorRules.code]" :disabled="!!model.id" placeholder="请输入数据源编码"/>
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="数据源名称">
          <a-input v-decorator="['name', validatorRules.name]" placeholder="请输入数据源名称"/>
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="数据库类型">
          <j-dict-select-tag v-decorator="['dbType', validatorRules.dbType]" dict-code="database_type" placeholder="请选择数据库类型" triggerChange @change="handleDbTypeChange"/>
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="驱动类">
          <a-input v-decorator="['dbDriver', validatorRules.dbDriver]" placeholder="请输入驱动类"/>
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="数据源地址">
          <a-input v-decorator="['dbUrl', validatorRules.dbUrl]" placeholder="请输入数据源地址"/>
        </a-form-item>
       <!-- <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="用户名">
          <a-input v-decorator="['dbUsername', validatorRules.dbUsername]" placeholder="请输入用户名"/>
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          ...
          <a-row :gutter="8">
            <a-col :span="21">
              <a-input-password v-decorator="['dbPassword', validatorRules.dbPassword]" placeholder="请输入密码"/>
            </a-col>
            <a-col :span="3">
              <a-button size="small" style="width: 100%" type="primary" @click="handleTest">测试</a-button>
            </a-col>
          </a-row>
        </a-form-item>
        <a-form-item
