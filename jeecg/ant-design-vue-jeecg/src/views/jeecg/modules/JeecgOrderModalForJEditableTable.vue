<template>
  <a-modal
    ...
    <a-spin :spinning="confirmLoading">
      <a-form-model ref="form" :label-col="labelCol" :model="model"  :wrapper-col="wrapperCol" >
        <!-- 主表单区域 -->
        <a-row :gutter="0" class="form-row">
          <a-col :lg="8">
            <a-form-model-item  :rules="[{ required: true, message: '请输入订单号!' }]" label="订单号" prop="orderCode">
              <a-input v-model="model.orderCode" placeholder="请输入订单号"/>
            </a-form-model-item>
          </a-col>
          <a-col :lg="8">
            <a-form-model-item  label="订单类型">
              <a-select v-model="model.ctype" placeholder="请选择订单类型">
          ...
          <a-col :lg="8">
            <a-form-model-item  label="订单日期">
              <a-date-picker v-model="model.orderDate" showTime style="width: 100%" valueFormat="YYYY-MM-DD HH:mm:ss"/>
            </a-form-model-item>
          </a-col>
        </a-row>
        <a-row :gutter="0" class="form-row">
          <a-col :lg="8">
            <a-form-model-item  label="订单金额">
              <a-input-number v-model="model.orderMoney" placeholder="请输入订单金额" style="width: 100%"/>
            </a-form-model-item>
          </a-col>
          <a-col :lg="8">
            <a-form-model-item  label="订单备注">
              <a-input v-model="model.content" placeholder="请输入订单备注"/>
            </a-form-model-item>
          </a-col>
        </a-row>
      </a-form-model>
      ...
      <a-tabs v-model="activeKey" @change="handleChangeTabs">
        <a-tab-pane key="1" :forceRender="true" tab="客户信息">
        ...
        <a-tab-pane key="2" :forceRender="true" tab="机票信息">
