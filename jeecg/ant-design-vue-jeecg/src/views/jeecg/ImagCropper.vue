    ...
    <div class="content">
      <div class="show-info">
        ...
        <div class="test-button">
          ...
          <button class="btn" @click="() => option.img = ''">清除图片</button>
        ...
        <div style="display:block; width: 100%;">
          ...
          <label class="c-item">
            ...
            <span>宽度:  </span><input v-model="option.autoCropWidth" type="number">
            <span>高度:  </span><input v-model="option.autoCropHeight" type="number">
          </label>
          <label class="c-item">
