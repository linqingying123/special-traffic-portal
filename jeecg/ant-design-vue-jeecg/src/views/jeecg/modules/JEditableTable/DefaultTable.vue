<template>
  ...
  <div>
    <a-button type="primary" @click="handleTableCheck">表单验证</a-button>
    <span style="padding-left:8px;"></span>
    <a-tooltip :autoAdjustOverflow="true" placement="top" title="获取值，忽略表单验证">
      <a-button type="primary" @click="handleTableGet">获取值</a-button>
    </a-tooltip>
    <span style="padding-left:8px;"></span>
    <a-tooltip :autoAdjustOverflow="true" placement="top" title="模拟加载1000条数据">
      <a-button type="primary" @click="handleTableSet">设置值</a-button>
    </a-tooltip>
