<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          ...
          <a-col :md="6" :sm="10">
            <a-form-model-item label="任务类名" prop="jobClassName">
              <a-input v-model="queryParam.jobClassName" placeholder="请输入任务类名"></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :md="6" :sm="10">
            <a-form-model-item label="任务状态" prop="status">
              <a-select v-model="queryParam.status" placeholder="请选择状态" style="width: 220px">
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" type="primary" @click="handleExportXls('定时任务信息')">导出</a-button>
    ...
    <div>
      ...
      <a-table
        ...
        <span slot="description" slot-scope="text">
          <j-ellipsis :length="20" :value="text" />
        </span>
