      ...
      <a-spin :spinning="confirmLoading">
        <a-form :form="form" class="form" @submit="handleSubmit">
          <a-row :gutter="24" class="form-row">
            <a-col :md="12" :sm="8">
              <a-form-item :label-col="{ span: 6 }"  :wrapper-col="{ span: 15 }" label="数据库表名">
                <a-input v-decorator="[ 'dataTale', {}]" disabled placeholder="请输入数据库表名" @blur="handleTableBlur"/>
              </a-form-item>
            </a-col>

            <a-col :md="12" :sm="8">
              <a-form-item :label-col="{ span: 5 }"  :wrapper-col="{ span: 15 }" label="数据ID">
                <a-input v-decorator="[ 'dataId', {}]" disabled placeholder="请输入数据ID" @blur="handleIdBlur"/>
              </a-form-item>
            </a-col>
          </a-row>
          ...
          <a-row :gutter="24" class="form-row">
            <a-col :md="12" :sm="8">
              <a-form-item :label-col="{ span: 6 }"  :wrapper-col="{ span: 15 }" label="版本号1">
                <a-select v-decorator="[ 'dataVersion1', {}]" placeholder="请选择版本号" @change="handleChange1">
            ...
            <a-col :md="12" :sm="8">
              <a-form-item :label-col="{ span: 5 }"  :wrapper-col="{ span: 15 }" label="版本号2">
                <a-select v-decorator="[ 'dataVersion2', {}]" placeholder="请选择版本号" @change="handleChange2">
                  <a-select-option v-for="(log,logindex) in DataVersionList" :key="logindex.toString()" :value="log.id">
                    {{ log.dataVersion }}
                  </a-select-option>
                </a-select>
