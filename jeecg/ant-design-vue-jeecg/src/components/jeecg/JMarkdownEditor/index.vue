<template>
  <div>
    <div :id="id" class="j-markdown-editor"/>
    <div v-if="isShow">
      <j-modal
        ...
        <a-tabs default-active-key="1" @change="handleChange">
          <a-tab-pane key="1" :forceRender="true" tab="本地图片上传">
            <j-upload v-model="fileList" :number="1"></j-upload>
            <div style="margin-top: 20px">
              <a-input v-model="remark" placeholder="请填写备注"></a-input>
            </div>
          </a-tab-pane>
          <a-tab-pane key="2" :forceRender="true" tab="网络图片地址">
            <a-input v-model="networkPic" placeholder="请填写网络图片地址"></a-input>
            <a-input v-model="remark" placeholder="请填写备注" style="margin-top: 20px"></a-input>
          </a-tab-pane>
        </a-tabs>
      </j-modal>
    </div>
