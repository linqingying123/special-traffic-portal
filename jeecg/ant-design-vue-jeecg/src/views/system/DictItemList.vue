            ...
            <a-row :gutter="10">
              <a-col :md="8" :sm="12">
                <a-form-item label="名称">
                  <a-input v-model="queryParam.itemText" placeholder="请输入名称" style="width: 120px;"></a-input>
                </a-form-item>
              </a-col>
              <a-col :md="9" :sm="24">
                <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="状态" style="width: 170px">
                  <a-select
