  ...
  <a-modal
    ...
    <a-spin :spinning="confirmLoading">
      <a-form-model ref="form" :model="model" :rules="validatorRules">
        ...
        <a-form-model-item :labelCol="labelCol"  :wrapperCol="wrapperCol" hasFeedback label="任务类名" prop="jobClassName" >
          <a-input v-model="model.jobClassName" placeholder="请输入任务类名" />
        </a-form-model-item>
        ...
        <a-form-model-item  :labelCol="labelCol" :wrapperCol="wrapperCol" label="参数" prop="parameter" >
          <a-textarea v-model="model.parameter" :rows="5" placeholder="请输入参数" />
        </a-form-model-item>
        <a-form-model-item :labelCol="labelCol"  :wrapperCol="wrapperCol" label="描述" prop="description">
          <a-textarea v-model="model.description" :rows="3" placeholder="请输入描述" />
        </a-form-model-item>
        <a-form-model-item :labelCol="labelCol" :wrapperCol="wrapperCol"  label="状态" prop="status">
          <j-dict-select-tag v-model="model.status" dictCode="quartz_status" type="radioButton"/>
        </a-form-model-item>
      </a-form-model>
    </a-spin>
  </a-modal>
