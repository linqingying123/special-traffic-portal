<template>
  <span v-if="syncToApp || syncToLocal">
    <j-third-app-dropdown v-if="enabledTypes.wechatEnterprise" name="企微" type="wechatEnterprise" v-bind="bindAttrs" v-on="bindEvents"/>
    <j-third-app-dropdown v-if="enabledTypes.dingtalk" name="钉钉" type="dingtalk" v-bind="bindAttrs" v-on="bindEvents"/>
  </span>
