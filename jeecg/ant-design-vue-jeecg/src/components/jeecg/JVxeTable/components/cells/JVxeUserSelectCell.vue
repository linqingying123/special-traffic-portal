<template>
  <div>
    <a-input
      ...
      readOnly
      @click="openSelect">
      <a-icon slot="prefix" title="用户选择控件" type="user"/>
    </a-input>
    <j-select-user-by-dep-modal
      ...
      @initComp="initComp"
      @ok="selectOK"/>
    <span v-if="userIds" style="display: inline-block;height:100%;padding-left:14px" >
      <span style="display: inline-block;vertical-align: middle" @click="openSelect">{{ userNames }}</span>
