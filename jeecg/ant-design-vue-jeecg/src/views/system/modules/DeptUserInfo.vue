<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="10">
          <a-col :md="10" :sm="12">
            <a-form-item label="用户账号" style="margin-left:8px">
              <a-input v-model="queryParam.username" placeholder="请输入账号"></a-input>
            </a-form-item>
          </a-col>
          <span class="table-page-search-submitButtons" style="float: left;overflow: hidden;">
            <a-col :md="6" :sm="24">
             <a-button icon="search" style="margin-left: 18px" type="primary" @click="searchQuery">查询</a-button>
    ...
    <!-- 操作按钮区域 -->
    <div :md="24" :sm="24" class="table-operator" style="margin-top: -15px">
      <!--<a-button @click="handleEdit" type="primary" icon="edit" style="margin-top: 16px">用户编辑</a-button>-->
      <a-button icon="plus" type="primary" @click="handleAddUserDepart">添加已有用户</a-button>
      <a-button icon="plus" style="margin-top: 16px" type="primary" @click="handleAdd">新建用户</a-button>
