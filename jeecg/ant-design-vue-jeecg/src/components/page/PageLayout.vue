<template>
  <div :style="!$route.meta.pageHeader ? 'margin: -10px -24px 0;' : null">
    ...
    <page-header v-if="!$route.meta.pageHeader" :avatar="avatar" :logo="logo" :title="title">
      ...
      <div slot="pageMenu">
        <div v-if="search" class="page-menu-search">
          <a-input-search enterButton="搜索" placeholder="请输入..." size="large" style="width: 80%; max-width: 522px;" />
        </div>
        <div v-if="tabs && tabs.items" class="page-menu-tabs">
          <!-- @change="callback" :activeKey="activeKey" -->
          <a-tabs :activeKey="tabs.active()" :tabBarStyle="{margin: 0}" @change="tabs.callback">
