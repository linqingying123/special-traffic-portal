<template>
  <a-row :gutter="8" class="j-select-biz-component-box" type="flex">
    <a-col :class="{'full': !buttons}" class="left">
      <slot name="left">
        <a-select
          v-model="selectValue"
          :disabled="disabled"
    ...
    <a-col v-if="buttons" class="right">
      <a-button :disabled="disabled" icon="search" type="primary" @click="visible=true">{{selectButtonText}}</a-button>
    </a-col>
