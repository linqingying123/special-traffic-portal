    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="发送方式">
          <j-dict-select-tag v-decorator="[ 'esType', {}]" :triggerChange="true" dictCode="msgType" placeholder="请选择发送方式">
          </j-dict-select-tag>
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="发送时间">
          <a-date-picker v-decorator="[ 'esSendTime', {}]" format='YYYY-MM-DD HH:mm:ss' showTime/>
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="发送状态">
          <j-dict-select-tag v-decorator="[ 'esSendStatus', {}]" :triggerChange="true" dictCode="msgSendStatus" placeholder="请选择发送状态">
          </j-dict-select-tag>
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
