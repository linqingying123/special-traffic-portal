  ...
  <div>
    <a-form-model ref="form" :model="model" :rules="validatorRules" class="password-retrieval-form">
      ...
      <a-form-model-item label="账号名" v-bind="layout">
        <a-input :value="accountName" disabled type="text"/>
      </a-form-model-item>

      <a-form-model-item class="stepFormText" label="新密码" prop="password" v-bind="layout">
        <a-input v-model="model.password" autocomplete="false" type="password"/>
      </a-form-model-item>

      <a-form-model-item class="stepFormText" label="确认密码" prop="confirmPassword" v-bind="layout">
        <a-input v-model="model.confirmPassword" autocomplete="false" type="password"/>
      </a-form-model-item>
