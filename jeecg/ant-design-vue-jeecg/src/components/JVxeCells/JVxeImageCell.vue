<template>
  <div>
    <template v-for="(file, fileKey) of [innerFile || {}]" v-if="hasFile">
      <div :key="fileKey" style="position: relative;">
        ...
        <template v-else-if="file['path']">
          <img :src="imgSrc" alt="无图片" class="j-editable-image" @click="handleMoreOperation"/>
        </template>
    ...
    <j-file-pop ref="filePop" :number="number" @ok="handleFileSuccess"/>
  </div>
</template>
