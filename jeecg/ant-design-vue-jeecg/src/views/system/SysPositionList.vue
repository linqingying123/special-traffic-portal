<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          ...
          <a-col :md="6" :sm="8">
            <a-form-item label="职务编码">
              <a-input v-model="queryParam.code" placeholder="请输入职务编码"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="8">
            <a-form-item label="职务名称">
              <a-input v-model="queryParam.name" placeholder="请输入职务名称"></a-input>
            </a-form-item>
          </a-col>
          <template v-if="toggleSearchStatus">
            <a-col :md="6" :sm="8">
              <a-form-item label="职级">
                <j-dict-select-tag v-model="queryParam.postRank" dictCode="position_rank" placeholder="请选择职级"/>
              </a-form-item>
            </a-col>
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" type="primary" @click="handleExportXls('职务表')">导出</a-button>
