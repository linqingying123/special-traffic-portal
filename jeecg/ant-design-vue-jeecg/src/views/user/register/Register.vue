  ...
  <div class="main user-layout-register">
    ...
    <a-form-model ref="form" :model="model" :rules="validatorRules">
      <a-form-model-item prop="username">
        <a-input v-model="model.username" autocomplete="false" placeholder="请输入用户名" size="large" type="text"/>
      </a-form-model-item>
      ...
      <a-form-model-item prop="password2">
        <a-input v-model="model.password2" autocomplete="false" placeholder="确认密码" size="large" type="password"></a-input>
      </a-form-model-item>

      <a-form-model-item prop="mobile">
        <a-input v-model="model.mobile" placeholder="11 位手机号" size="large">
          <a-select slot="addonBefore" defaultValue="+86" size="large">
      ...
      <a-row :gutter="16">
        <a-col :span="16" class="gutter-row">
          <a-form-model-item prop="captcha">
            <a-input v-model="model.captcha" placeholder="验证码" size="large" type="text">
