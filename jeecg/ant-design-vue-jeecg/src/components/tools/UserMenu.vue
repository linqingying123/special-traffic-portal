<template>
  <div :class="theme" class="user-wrapper">
    ...
    <component :is="searchMenuComp" v-show="searchMenuVisible || isMobile()" :footer="null" :visible="searchMenuVisible" class="borders" title="搜索菜单" @cancel="searchMenuVisible=false">
      <a-select
    ...
    <span class="action">
      <a class="logout_title" href="http://doc.jeecg.com" target="_blank">
