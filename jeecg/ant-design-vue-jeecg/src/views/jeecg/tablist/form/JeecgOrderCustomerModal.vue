<template>
  <a-modal
    ...
    <!-- 编辑 -->
    <a-spin v-if="editStatus" :spinning="confirmLoading">
      <a-form-model ref="form" :model="model" :rules="validatorRules">
        <a-form-model-item
          ...
          prop="name"
          required>
          <a-input v-model="model.name" :readOnly="disableSubmit" placeholder="请输入客户姓名"/>
        </a-form-model-item>
        <a-form-model-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-model-item
          ...
          label="身份证号码"
          prop="idcard">
          <a-input v-model="model.idcard" :readOnly="disableSubmit" placeholder="请输入身份证号码"/>
        </a-form-model-item>
        <a-form-model-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          hasFeedback
          label="身份证扫描件">
          <j-image-upload v-model="fileList" :isMultiple="true" text="上传"></j-image-upload>
        </a-form-model-item>
        <a-form-model-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
