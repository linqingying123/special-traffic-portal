  ...
  <a-modal
    ...
    <a-spin :spinning="confirmLoading">
      <a-form-model ref="form" :model="model" :rules="validatorRules">
        ...
        <a-form-model-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="父级节点" prop="pid">
          <j-tree-select
            ref="treeSelect"
            v-model="model.pid"
            :disabled="disabled"
        ...
        <a-form-model-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="分类名称" prop="name">
