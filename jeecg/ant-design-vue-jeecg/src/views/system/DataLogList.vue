<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          <a-col :md="6" :sm="8">
            <a-form-item label="表名">
              <a-input v-model="queryParam.dataTable" placeholder="请输入表名"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="8">
            <a-form-item label="数据ID">
              <a-input v-model="queryParam.dataId" placeholder="请输入ID"></a-input>
            </a-form-item>
          </a-col>
    ...
    <div class="table-operator">
      <a-button icon="plus" type="primary" @click="handleCompare()">数据比较</a-button>
    </div>
    ...
    <div>
      ...
      >
        ...
        <span slot="dataContent" slot-scope="text, record">
          <j-ellipsis :length="80" :value="text" />
        </span>
      </a-table>
    </div>
