<template>
  <page-layout logo="https://gw.alipayobjects.com/zos/rmsportal/nxkuOJlFJuAUhzlMTCEe.png" title="单号：234231029431">

    <detail-list slot="headerContent" :col="2" class="detail-layout" size="small">
    ...
    <a-card :bordered="false" title="流程进度">
      <a-steps :current="1" :direction="isMobile() && 'vertical' || 'horizontal'" progressDot>
        <a-step title="创建项目">
        </a-step>
        <a-step title="部门初审">
        </a-step>
    ...
    <a-card :bordered="false" style="margin-top: 24px" title="用户信息">
      <detail-list>
      ...
      <a-card title="多层信息组" type="inner">
        <detail-list size="small" title="组名称">
    ...
    <a-card :bordered="false" style="margin-top: 24px" title="用户近半年来电记录">
