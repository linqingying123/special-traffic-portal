<template>
  <div class="j-easy-cron">
    <div class="content">
      <div>
        <a-tabs v-model="curtab" size="small">
          ...
          <a-tab-pane key="day" tab="日">
            <day-ui v-model="day" :disabled="disabled" :week="week"></day-ui>
          </a-tab-pane>
        ...
        <a-col :span="18" style="margin-top: 22px;">
          <a-row :gutter="8">
            <a-col :span="8" style="margin-bottom: 8px;">
              <a-input v-model="inputValues.second" addon-before="秒" @blur="onInputBlur"/>
            </a-col>
            <a-col :span="8" style="margin-bottom: 8px;">
              <a-input v-model="inputValues.minute" addon-before="分" @blur="onInputBlur"/>
            </a-col>
            <a-col :span="8" style="margin-bottom: 8px;">
              <a-input v-model="inputValues.hour" addon-before="时" @blur="onInputBlur"/>
            </a-col>
            <a-col :span="8" style="margin-bottom: 8px;">
              <a-input v-model="inputValues.day" addon-before="日" @blur="onInputBlur"/>
            </a-col>
            <a-col :span="8" style="margin-bottom: 8px;">
              <a-input v-model="inputValues.month" addon-before="月" @blur="onInputBlur"/>
            </a-col>
            <a-col :span="8" style="margin-bottom: 8px;">
              <a-input v-model="inputValues.week" addon-before="周" @blur="onInputBlur"/>
            </a-col>
            <a-col :span="8" style="margin-bottom: 8px;">
              <a-input v-model="inputValues.year" addon-before="年" @blur="onInputBlur"/>
            </a-col>
            <a-col :span="16" style="margin-bottom: 8px;">
              <a-input v-model="inputValues.cron" addon-before="Cron" @blur="onInputCronBlur"/>
            </a-col>
          </a-row>
        </a-col>
        <a-col :span="6">
