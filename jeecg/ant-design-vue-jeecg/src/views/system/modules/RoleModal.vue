  ...
  <a-modal
    ...
    <a-spin :spinning="confirmLoading">
      <a-form-model ref="form"  :model="model"  :rules="validatorRules" v-bind="layout">
        <a-form-model-item label="角色编码" prop="roleCode" required>
          <a-input v-model="model.roleCode" :disabled="roleDisabled"  placeholder="请输入角色编码"/>
        </a-form-model-item>
        <a-form-model-item label="角色名称" prop="roleName" required>
          <a-input v-model="model.roleName" placeholder="请输入角色名称"/>
        </a-form-model-item>
        <a-form-model-item label="描述" prop="description">
          <a-textarea v-model="model.description" :rows="5" placeholder="请输入角色描述"/>
        </a-form-model-item>
      </a-form-model>
    </a-spin>
  </a-modal>
