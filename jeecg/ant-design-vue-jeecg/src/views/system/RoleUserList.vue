      ...
      <a-card :bordered="false">
        ...
        <div class="table-page-search-wrapper">
          ...
          <a-form layout="inline" @keyup.enter.native="searchQuery">
            <a-row :gutter="24">
              <a-col :md="12" :sm="8">
                <a-form-item :labelCol="{span: 5}" :wrapperCol="{span: 18, offset: 1}" label="角色名称">
                  <a-input v-model="queryParam.roleName" placeholder=""></a-input>
                </a-form-item>
              </a-col>
              <!--
              <a-col :md="11" :sm="12">
            ...
            <a-col :md="12" :sm="24">
               <a-button icon="search" style="margin-left: 21px" type="primary" @click="searchQuery">查询</a-button>
        ...
        <div class="table-operator" style="margin: 5px 0 10px 2px">
          <a-button icon="plus" type="primary" @click="handleAdd">新建角色</a-button>
          ...
          <a-button icon="download" type="primary" @click="handleExportXls('角色管理')">导出</a-button>
        </div>
    ...
    <a-col v-if="this.rightcolval == 1" :md="rightColMd" :sm="24">
      <a-card :bordered="false">
            ...
            <a-row :gutter="24">
              ...
              <a-col :md="12" :sm="12">
                <a-form-item label="用户账号">
                  <a-input v-model="queryParam2.username" placeholder=""></a-input>
                </a-form-item>
              </a-col>
              <span class="table-page-search-submitButtons" style="float: left;overflow: hidden;">
            <a-col :md="9" :sm="24">
             <a-button icon="search" style="margin-left: 21px" type="primary" @click="searchQuery2">查询</a-button>
              <a-button icon="reload" style="margin-left: 8px" type="primary" @click="searchReset2">重置</a-button>
        ...
        <div :md="24" :sm="24" class="table-operator">
          <a-button icon="plus" style="margin-top: 16px" type="primary" @click="handleAdd2">新增用户</a-button>
          <!--<a-button @click="handleEdit2" type="primary" icon="edit" style="margin-top: 16px">用户编辑</a-button>-->
          <a-button icon="plus" style="margin-top: 16px" type="primary" @click="handleAddUserRole">已有用户</a-button>
